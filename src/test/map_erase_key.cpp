...
int main(void)
{
	...
	std::cout << "Erase succes of 'z' ? : " << m1.erase('z') << std::endl;
	std::cout << "Erase succes of 'e' ? : " << m1.erase('e') << std::endl;
	std::cout << "Erase succes of 'e' ? : " << m1.erase('e') << std::endl;
	std::cout << "Erase succes of 'c' ? : " << m1.erase('c') << std::endl;

	std::cout << "----------" << std::endl;
	map<char, int>::iterator it1 = m1.begin();
	map<char, int>::iterator ite1 = m1.end();
